"""Native cognis-connect emit for crossforge — forward findings to any platform.

Maps crossforge's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    crossforge ... --format json | crossforge-emit --to stix
    crossforge-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
